...
I have hands-on experience with JavaScript, Python, Java, React, C, and C++, though 
I'm still building confidence with real-world open-source workflows — reading a 
repo's structure, following contribution guidelines, and using Git/GitHub 
collaboratively rather than just for personal projects. This unit is a chance to 
practice exactly those skills: evaluating issues, working through the pick-reproduce-
fix-land workflow, and getting comfortable with the tools this course builds (skills, 
rubrics, eval loops). I'd prefer to avoid issues that are heavy on complex mathematical 
computation, since my focus right now is on the contribution process and tooling 
rather than algorithm-heavy problem solving.
